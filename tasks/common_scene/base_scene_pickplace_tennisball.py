...
"""
public base scene configuration module (tennis ball on green base)
provides a scene with the G1 robot facing a packing table, a static green
cylindrical base sitting on the table, and a tennis ball resting on top of it.
"""
...
@configclass
class TableTennisBallSceneCfg(InteractiveSceneCfg):
    """scene: G1 robot + packing table + green base + tennis ball."""
