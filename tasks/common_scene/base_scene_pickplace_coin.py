...
"""
public base scene configuration module (vertical coin on green base)
provides a scene with the G1 robot facing a packing table, a static green
cylindrical base sitting on the table, and a thin coin standing vertically
on top of it.
"""
...
class TableCoinSceneCfg(InteractiveSceneCfg):
    """scene: G1 robot + packing table + green base + vertical coin."""
