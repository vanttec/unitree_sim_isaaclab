...
from tasks.common_scene.base_scene_pickplace_cardsdeck import TableCardsDeckSceneCfg
...
@configclass
class ObjectTableSceneCfg(TableCardsDeckSceneCfg):
...
class EventCfg:
    reset_object = EventTermCfg(
        ...
        params={
            ...
            "pose_range": {
                "x": [-0.01, 0.01],  # small jitter; base radius 0.055 keeps deck centered
                "y": [-0.01, 0.01],
            },
