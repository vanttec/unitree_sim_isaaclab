...
from tasks.common_scene.base_scene_pickplace_stick import TableStickSceneCfg
...
@configclass
class ObjectTableSceneCfg(TableStickSceneCfg):
...
class EventCfg:
    reset_object = EventTermCfg(
        ...
        params={
            ...
            "pose_range": {
                "x": [0.0, 0.0],  # no jitter; balanced stick on cradle would topple
                "y": [0.0, 0.0],
            },
